...
public class Recipe_salting extends AppCompatActivity {
    Button home;
    Button refrigerator;
    Button recipe;
    Button setting;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe_salting);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Recipe_frying.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Recipe_plating.class);
                startActivity(intent);
            }
        });
    }
