...
public class Delete extends AppCompatActivity {
    ...
    //삭제할 재료의 이름 담는곳
    String[] totalName=new String[30];
    @Override
    ...
    private void delHDB(String deleteItem){
        if (click == 1) {
            try {
                ...
                sampleDB.execSQL("delete from highRef where name=\'"+deleteItem+"\'");
    ...
    private void delLDB(String deleteItem){
        if (click == 1) {
            try {
                ...
                sampleDB.execSQL("delete from lowRef where name=\'"+deleteItem+"\'");
